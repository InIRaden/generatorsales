...
import { R as Route, s as supabase } from "./router-bJNx2uWH.js";
import { A as AppHeader } from "./AppHeader-DwErxbN_.js";
import { a as TEMPLATES, S as SalesPageView } from "./SalesPageView-DKoen4Gf.js";
import { B as Button, c as cn } from "./button-BmLZMIt9.js";
import { Loader2, ArrowLeft, Edit3, Download } from "lucide-react";
...
function exportSalesPageHtml(content, template, productName) {
  const themes = {
...
function PageView() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "sticky top-16 z-30 glass border-b", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-3 flex flex-wrap items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold truncate", children: productName }),
          /* @__PURE__ */ jsxs("div", { className: "text-xs text-muted-foreground", children: [
            "Live preview ",
            savingTpl && "• saving template…"
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
        /* @__PURE__ */ jsx("div", { className: "flex items-center gap-1 rounded-full bg-white/5 border border-white/10 p-1", children: TEMPLATES.map((t) => /* @__PURE__ */ jsx("button", { onClick: () => updateTemplate(t.id), className: cn("text-xs px-3 py-1.5 rounded-full transition", template === t.id ? "bg-gradient-brand text-primary-foreground" : "text-muted-foreground hover:text-foreground"), children: t.name }, t.id)) }),
        /* @__PURE__ */ jsx(Button, { asChild: true, variant: "secondary", size: "sm", children: /* @__PURE__ */ jsxs(Link, { to: "/page/$id/edit", params: {
          id
        }, children: [
          /* @__PURE__ */ jsx(Edit3, { className: "h-3.5 w-3.5 mr-1.5" }),
          "Edit"
        ] }) }),
        /* @__PURE__ */ jsxs(Button, { onClick: handleExport, size: "sm", className: "bg-gradient-brand text-primary-foreground hover:opacity-90", children: [
          /* @__PURE__ */ jsx(Download, { className: "h-3.5 w-3.5 mr-1.5" }),
          "Export HTML"
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsx("main", { className: "mx-auto max-w-[1400px] px-4 sm:px-6 py-6", children: /* @__PURE__ */ jsx("div", { className: "rounded-2xl overflow-hidden border border-white/10 shadow-card-soft", children: content && /* @__PURE__ */ jsx(SalesPageView, { content, template }) }) })
  ] });
}
export {
